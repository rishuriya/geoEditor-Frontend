  ...
  return (
    <div className="w-1/3 items-center ">
      ...
      <div>
        <label
          for="large"
          class="block min-w-[175px] mb-2 text-base font-medium text-gray-900 dark:text-gray-400 mx-10"
        >
          Select Country
        </label>
        <select
          ...
          class="block min-w-[175px] py-3 px-4 mx-10 text-base text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
        >
